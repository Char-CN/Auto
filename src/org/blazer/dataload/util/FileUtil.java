...
public class FileUtil {
	...
	public static String[] findFileNameRegexp(String filePath, String regexp) throws DirectoryNotFoundException {
		File directory = new File(filePath);
		if (!directory.isDirectory()) {
			throw new DirectoryNotFoundException(filePath + " is not directory");
		}
	...
	public static void main(String[] args) throws DirectoryNotFoundException {
		System.out.println(StringUtil.findStrByReg(null, null));
